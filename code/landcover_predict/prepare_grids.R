...
predict_grid_1k_tif <- readGDAL("/data6/EthiopiaData/GEOdata/ET_1K_Gtif_20131223/fPAR_mask.tif", silent=TRUE)
...
#raster fileinfo
tif.info <- GDALinfo("/data6/EthiopiaData/GEOdata/ET_1K_Gtif_20131223/fPAR_mask.tif", silent=TRUE)
